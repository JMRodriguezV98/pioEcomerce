...
exports.registrarUsuario = async (req, res) => {
    ...
    try {
        ...
        const resultado = await pool.query(
            'INSERT INTO users (nombre, correo, password, direccion, telefono, rol) VALUES ($1, $2, $3, $4, $5, $6) RETURNING *',
...
exports.iniciarSesion = async (req, res) => {
    ...
    try {
        const resultado = await pool.query('SELECT * FROM users WHERE correo = $1', [correo]);
...
exports.obtenerPerfilUsuario = async (req, res) => {
    ...
    try {
        const resultado = await pool.query('SELECT id, nombre, correo, direccion, telefono, rol, fecha_creacion FROM users WHERE id = $1', [userId]);
...
exports.actualizarPerfilUsuario = async (req, res) => {
    ...
    try {
        const resultado = await pool.query(
            'UPDATE users SET nombre = $1, correo = $2, direccion = $3, telefono = $4, rol = $5 WHERE id = $6 RETURNING *',
